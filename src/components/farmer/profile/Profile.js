...
import { selectFarmerProfileData } from '../../../store/farmer/Profile';
...
const Profile = () => {
  ...
  const franchisorData = useSelector(selectFarmerProfileData);
  const {
    firstName,
    phoneNumber,
    dob,
            ...
            <div className='box-border  rounded-md px-8 py-8 bg-white shadow-lg'>
              ...
              >
                ...
                <div>
                  ...
                  <Link to="/franchisor/edit_profile" className="flex justify-center items-center bg-[#A020F0] rounded-lg text-base px-3 py-2.5  text-white font-medium ">
                    Edit Profile
                  </Link>
