  ...
  useEffect(() => {
    const fetchAdmins = async () => {
      try {
        ...
        const response = await axios.get('https://api.afribook.world/admin/admins', {
          headers: {
  ...
  return (
    <div className="container mx-auto px-6">
      ...
      <AdminProfile
        ...
        adminDetails={admins.find(admin => admin.userId === selectedAdminId) || {}} // Pass admin details as prop
      />
    </div>
  );
};
