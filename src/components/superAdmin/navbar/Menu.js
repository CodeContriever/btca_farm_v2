...
const Menu = ({ activeButton, handleHamburgerClick, onNavigate }) => {
 ...
 <li >
            ...
            {/* Pending Sales */}
             ...
             <li >
              <button className="cursor-pointer text-gray-800 hover:text-[#A020F0] focus:text-[#A020F0]" onClick={() => handleMenuItemClick('pendingSales')}>Pending Sales</button>
            </li>

            {/* Approved Sales */}
             <li >
              <button className="cursor-pointer text-gray-800 hover:text-[#A020F0] focus:text-[#A020F0]" onClick={() => handleMenuItemClick('approvals')}>Approved Sales</button>
            </li>

            {/* Payments */}
             <li >
              <button className="cursor-pointer text-gray-800 hover:text-[#A020F0] focus:text-[#A020F0]" onClick={() => handleMenuItemClick('payments')}>Payments</button>
            </li>
            

            {/* Orders */}
             <li>
              <button className="cursor-pointer text-gray-800 hover:text-[#A020F0] focus:text-[#A020F0]" onClick={() => handleMenuItemClick('orders')}>Orders</button>
            </li>
