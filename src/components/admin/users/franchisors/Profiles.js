...
const FranchisorProfile = ({ viewProfile, setViewProfile, userId, franchisorDetails }) => {
        ...
        <Modal.Body>
          <div className="space-y-6">
            ...
            <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
              Full Name: <span>{franchisorDetails.fullName}</span>
            </p>

            <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
              Role: <span>{franchisorDetails.role?.roleType || 'N/A'}</span>
            </p>
          </div>
        </Modal.Body>
