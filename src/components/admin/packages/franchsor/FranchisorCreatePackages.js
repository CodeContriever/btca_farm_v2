...
const FranchisorCreatePackages = ({ franchisorCreatedPackages, setFranchisorCreatedPackages }) => {
  ...
  const handleCreatePackage = async () => {
    try {
      ...
      const response = await axios.post('https://api.afribook.world/package/createFranchisorPackage', {
        price,
        packageName,
        reward,
        description,
 ...
 Authorization: `Bearer ${accessToken}`,
      ...
      if (response.status === 200) {
        ...
        setFranchisorCreatedPackages([...franchisorCreatedPackages, newPackage]);
...
export default FranchisorCreatePackages;
