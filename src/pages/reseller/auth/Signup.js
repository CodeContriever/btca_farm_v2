...
import { setResellerSignupData } from '../../../store/reseller/Signup';
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        dispatch(setResellerSignupData(data));
              ...
              <form className="py-1" onSubmit={handleSubmit}>
                ...
                <div className="py-4 flex flex-row gap-8">
                  <span className="text-gray-500">
                    Already Registered? <Link className="text-red-500 ml-2" to="/reseller/signin">Login Now</Link>
                  </span>
                </div>
              </form>
            </div>
