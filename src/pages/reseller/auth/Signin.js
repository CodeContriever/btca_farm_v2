...
const Signin = () => {
  ...
  const redirectPath = location.state?.path || '/reseller'
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className='text-gray-500'>Forgot Password? <Link className='text-red-500' to="/reseller/reset_password">Recover Now</Link></span>
