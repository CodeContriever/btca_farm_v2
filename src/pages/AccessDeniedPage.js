      ...
      <main class="min-h-screen bg-[#F9FAFB] dark:bg-gray-900">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div class="mx-auto max-w-screen-sm text-center">
            ...
            <p class="mb-4 text-3xl tracking-tight font-bold text-red-700 md:text-4xl dark:text-white">Access Denied!</p>

            <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry, you don't have the authorization to view this page </p>
